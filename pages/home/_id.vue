            ...
            <div class="container px-5 py-24 mx-auto">
                <div class="lg:w-4/5 mx-auto flex flex-wrap">
                    ...
                    <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <h1 class="text-gray-900 text-3xl title-font font-medium mb-1">{{ product2.title }}</h1>
                        <div class="flex mb-4">
                        ...
                        <p class="leading-relaxed">{{ product2.description }}</p>
                        ...
                        <div class="flex">
                            <span class="title-font font-medium text-2xl text-gray-900">{{ product2.price }}</span>
                            <input type="number" v-model="quantity" />
                            <button
                                class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded"
                                @click="ProductCart2">Button</button>
                            <button
...
export default {
    ...
    methods: {
        ...
        async ProductCart2() {
            ...
            this.$store.dispatch("ListProduct3", data)
        },
        openEmit(count){
            console.log(count);
        }
    ...
    computed: {
        computedPrice() {
            return this.product2.price * this.quantity
        }
